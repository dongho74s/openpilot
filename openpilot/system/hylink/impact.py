...
from openpilot.system.hylink.runtime import CONFIG_PATH

STANDARD_GRAVITY = 9.80665
DEFAULT_IMPACT_QUEUE_PATH = Path(os.getenv(
  "WAYON_IMPACT_QUEUE", str(CONFIG_PATH.with_name("impact_queue.jsonl"))))
DEFAULT_IMPACT_DIAGNOSTICS_PATH = Path(os.getenv(
  "WAYON_IMPACT_DIAGNOSTICS", str(CONFIG_PATH.with_name("impact_diagnostics.jsonl"))))
