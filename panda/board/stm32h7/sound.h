...
void sound_init(void) {
  ...
  // Cuatro uses SAI4 A/B. SAI1 is unclocked; registering a write to its GCR
  // creates a registerDivergent fault because the write cannot take effect.
  ...
  // DTRBS is writable only while CHEN=0. Configure it before enabling CH3.
  register_set(&DFSDM1_Channel3->CHCFGR2, (2U << DFSDM_CHCFGR2_DTRBS_Pos), DFSDM_CHCFGR2_OFFSET_Msk | DFSDM_CHCFGR2_DTRBS_Msk);
